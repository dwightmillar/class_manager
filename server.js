...
server.get('/class_manager/api/classes', function (request, response, next) {
  let params = [];
...
server.get('/class_manager/api/students', function (request, response, next) {
  let params = [];
...
server.get('/class_manager/api/assignments', function (request, response, next) {
    let params = [];
...
server.post('/class_manager/api/students', function (request, response, next) {
    let params = [];
...
server.delete('/class_manager/api/students', function (request, response, next) {
    let params = [];
...
server.delete('/class_manager/api/classes', function (request, response, next) {
    let params = [];
...
server.post('/class_manager/api/assignments', function (request, response, next) {
...
server.post('/class_manager/api/classes', function (request, response, next) {
    let params = [];
...
server.patch('/class_manager/api/assignments', function (request, response, next) {
